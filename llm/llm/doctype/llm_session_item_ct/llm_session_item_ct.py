...
from llm.core.types import EndReason, Meta, SessionItem, SessionRole

if TYPE_CHECKING:
	from frappe.types import DF


class LLMSessionItemCT(Document):
	...
	@staticmethod
	def from_session_item(item: SessionItem) -> LLMSessionItemCT:
		osi = cast("LLMSessionItemCT", frappe.new_doc("LLM Session Item CT"))
